...
import com.ljwx.basepermission.R
...
class PermissionUtil {
    companion object {
        ...
        fun requestLocationPermission(activity: FragmentActivity?, callBack: IPermissionCallBack) {
            ...
            val callback = object : IPermissionCallBack {
                override fun onPermissionsGranted(grantedAll: Boolean, perms: List<String>) {
                    if (grantedAll) {
                        //检查gps权限
            ...
            requestPermissions(
                activity, PermissionConstants.PermissionType.ACCESS_FINE_LOCATION
                        or PermissionConstants.PermissionType.ACCESS_COARSE_LOCATION,
                PermissionConstants.RationaleType.LOCATION, callBack
            )
        }
