    ...
    public static ResponseThrowable handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            switch (httpException.code()) {
                case UNAUTHORIZED:
                    ex.message = "Operation not authorized";
                    break;
                case FORBIDDEN:
                    ex.message = "Request denied";
                    break;
                case NOT_FOUND:
                    ex.message = "Resource does not exist";
                    break;
                case REQUEST_TIMEOUT:
                    ex.message = "Server execution timed out";
                    break;
                case INTERNAL_SERVER_ERROR:
                    ex.message = "Internal server error";
                    break;
                case SERVICE_UNAVAILABLE:
                    ex.message = "Server unavailable";
                    break;
                default:
            ...
            ex = new ResponseThrowable(e, ERROR.TIMEOUT_ERROR);
            ex.message = "Host address unknown";
            return ex;
        } else {
